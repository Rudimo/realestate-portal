...
Galleria.addTheme = function( theme ) {
    ...
    var css = true, // @changed (false -> true) hack galleria for Google page speed (css bundled)
        reg, reg2;

    _themeLoad( theme ); // @added hack galleria for Google page speed (css bundled)

    return theme; // @added hack galleria for Google page speed (css bundled)
